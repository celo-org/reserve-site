...
export const newKit = jest.fn(() => {
  return {
    contracts: {
      ...
      getReserve: async () => ({
        getReserveCeloBalance: jest.fn(async () => new mockBigNumber("1.19589497940550414165549272e+26")),
        getUnfrozenBalance:  jest.fn(async () => new mockBigNumber("7.533063107819435353416241e+25")),
      }),
      getGoldToken: async () => ({
